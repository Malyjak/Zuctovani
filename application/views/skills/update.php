            ...
            <div class="col-md-12 col-xs-12">
                ...
                <div class="box">
                    <div class="box-header">
                        <h3 class="box-title">Upravit dovednost</h3>
                    </div>
                    <form role="form" action="<?php base_url('skills/update') ?>" method="post"
                        ...
                        <div class="box-body">
                            ...
                            $skill_id = end($link_array);
                            if ($skill_id) {
                                $skill_data = $this->model_skills->getSkillData($skill_id);
                            } ?>
                            <div class="form-group">
                                <label for="name">Název</label>
                                <input type="text" class="form-control" id="name" name="name"
                                       placeholder="Název" value="<?php echo $skill_data['name']; ?>"
                                       autocomplete="off" required/>
                            </div>
                            <div class="form-group">
                                <label for="attribute">Atribut</label>
                                <select class="form-control" id="attribute" name="attribute">
                                    <option value="1" <?php if ($skill_data['attribute'] == 1) {
                                        echo "selected='selected'";
                                    } ?>>Kondice
                                    </option>
                                    <option value="2" <?php if ($skill_data['attribute'] == 2) {
                                        echo "selected='selected'";
                                    } ?>>Mysl
                                    </option>
                                    </option>
                                    <option value="3" <?php if ($skill_data['attribute'] == 3) {
                                        echo "selected='selected'";
                                    } ?>>Působivost
                                    </option>
                                </select>
                            ...
                            <div class="form-group">
                                ...
                                <textarea type="text" class="form-control" id="description" name="description"
                                        ...
                                        <?php echo $skill_data['description']; ?>
                                </textarea>
                            </div>
                        </div>
