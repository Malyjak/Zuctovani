...
<div class="content-wrapper">
    ...
    <section class="content-header">
        ...
        <p>Zde se bude zobrazovat log pro vypravěče o tom co se s postavami stalo</p>
        <p>xp gained, lvl up, gold gained, gold spent, items received, items sold/given, monsters killed, ...</p>
        <ol class="breadcrumb">
