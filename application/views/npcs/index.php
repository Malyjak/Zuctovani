        ...
        <div class="row">
            <div class="col-md-12 col-xs-12">
                ...
                <?php if (in_array('createNpc', $user_permission)): ?>
                    <a href="<?php echo base_url('npcs/create') ?>" class="btn btn-primary">Přidat NPC</a>
                    <br/> <br/>
                <?php endif; ?>
                <div class="box">
                    <div class="box-header">
                        <h3 class="box-title">Spravovat NPC</h3>
                    </div>
                    <div class="box-body">
                        <table id="npcTable" class="table table-bordered table-striped">
                            <thead>
                            <tr>
                                <th>Jméno</th>
                                <th>Lvl</th>
                                ...
                                <th>Dovednosti</th>
                                <th>Inventář</th>
                                <?php if (in_array('updateNpc', $user_permission) || in_array('deleteNpc', $user_permission)): ?>
                                    <th>Akce</th>
                                <?php endif; ?>
                            </tr>
                            </thead>
...
<script type="text/javascript">
    ...
    $(document).ready(function () {
        ...
        npcTable = $('#npcTable').DataTable({
            'ajax': base_url + 'npcs/fetchNpcData',
            'order': []
        });
            ...
            $("#removeForm").on('submit', function () {
                ...
                $.ajax({
                    ...
                    success: function (response) {
                        npcTable.ajax.reload(null, false);
